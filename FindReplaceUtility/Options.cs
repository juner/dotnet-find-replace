...
namespace FindReplaceUtility
{
    public class Options
    {
        ...
        public void Deconstruct(out string Current, out bool IsList, out string Include, out string Exclude, out string Find, out string Replace)
            => (Current, IsList, Include, Exclude, Find, Replace)
            = (this.Current, this.IsList, this.Include, this.Exclude, this.Find, this.Replace);
    }
}
